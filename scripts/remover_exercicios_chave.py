...
PALAVRA_A_REMOVER = ['unilateral', ' unilateral ', ' unilaterais', ' unilaterais ', ' unilateral.', ' unilateral,', ' unilaterais.', ' unilaterais,' 'isométrico', ' isométrico ', ' isométricos', ' isométricos ', ' isométrico.', ' isométrico,', ' isométricos.', ' isométricos,', 'isometrico', ' isometrico ', ' isometricos', ' isometricos ', ' isometrico.', ' isometrico,', ' isometricos.', ' isometricos,', 'estático', ' estático ', ' estáticos', ' estáticos ', ' estático.', ' estático,', ' estáticos.', ' estáticos,', 'estatico', ' estatico ', ' estaticos', ' estaticos ', ' estatico.', ' estatico,', ' estaticos.', ' estaticos,' 'contralateral', ' contralateral ', ' contralaterais', ' contralaterais ', ' contralateral.', ' contralateral,', ' contralaterais.', ' contralaterais,' 'kettlebell', ' kettlebell ', ' kettlebells', ' kettlebells ', ' kettlebell.', ' kettlebell,', ' kettlebells.', ' kettlebells,', 'alongamento', ' alongamento ', ' alongamentos', ' alongamentos ', ' alongamento.', ' alongamento,', ' alongamentos.', ' alongamentos,', 'parede', ' parede ', ' paredes', ' paredes ', ' parede.', ' parede,', ' paredes.', ' paredes,' 'v. 2', ' v. 2 ', ' v2', ' v2 ', 'isometria', ' isometria ', ' isometrias', ' isometrias ', ' isometria.', ' isometria,', ' isometrias.', ' isometrias,']
# ------------------------------
